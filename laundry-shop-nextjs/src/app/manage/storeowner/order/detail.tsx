    ...
    <>
      ...
      >
        <Descriptions title="Thông tin lịch khám" bordered column={1}>
          <Descriptions.Item label="Tài khoản">null</Descriptions.Item>
