...
import zalo from "@/assets/footer/zalo-icon.svg";
import ins from "@/assets/footer/ins-icon.svg";
  ...
  return (
    <footer className="bg-black w-full py-12 text-xl text-gray-400 leading-loose">
      <div className="w-full mx-auto lg:max-w-6xl">
        ...
        <div>CN2: 18A/71 Nguyễn Thị Minh Khai, Phường Đa Kao, Quận 1, HCM</div>
        ...
        <div className="flex flex-col gap-4">
          <div>
            <img className="w-auto h-[50px]" src={Logo} alt="Logo" />
          </div>
          ...
          <div className="text-white text-base">
            ...
            ứng dụng giúp hàng triệu người có thể đặt các dịch vụ giặt ủi , giặt
            hấp , vệ sinh giày , vệ sinh nhà cửa , vệ sinh máy lạnh tiện lợi ,
            từ đó, mọi người sẽ có thêm nhiều thời gian để tận hưởng cuộc sống.
          </div>
          <div className="text-white text-base">
            Sau hơn 6 năm hoạt động và tiên phong ứng dụng công nghệ 4.0, HERAMO
            tự hào là thương hiệu dẫn đầu trong ngành giặt là, giặt hấp, vệ sinh
            chăm sóc giày, vệ sinh sofa, nệm, rèm, thảm, vệ sinh máy lạnh tại
            TP.Hồ Chí Minh với 136.000+ khách hàng tin dùng.
          </div>
          <div className="text-white text-base">
